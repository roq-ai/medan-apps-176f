...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Game Release.create': {
    roles: ['business-owner', 'team-member', 'customer-service-representative'],
    key: 'game_developer',
    tenantPath: [],
    userPath: [],
  },
  'Major Issue Reported.update': {
    roles: ['business-owner', 'team-member', 'game-developer'],
    key: 'customer_service_representative',
    tenantPath: [],
    userPath: [],
  },
  'Scheduled Maintenance.create': {
    roles: ['business-owner', 'game-developer', 'customer-service-representative'],
    key: 'team_member',
    tenantPath: [],
    userPath: [],
  },
