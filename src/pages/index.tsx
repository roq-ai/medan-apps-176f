...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Medan Apps`}</title>

        <meta
          name="description"
          content="Welcome to Medan Apps - Your Ultimate Online Destination for Web PPOB and Gamers. Streamline Your Experience, Enhance Your Gaming, and Simplify Your Web PPOB Transactions."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1460925895917-afdab827c52f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3ZWIlMjBQUE9CfGVufDB8fHx8MTY5NjcyMjE0MXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Medan Apps - Your Ultimate Online Destination for Web PPOB and Gamers. Streamline Your Experience, Enhance Your Gaming, and Simplify Your Web PPOB Transactions.`}
            </Text>
            <Box
